    ...
    private function get_meta_description()
    {
        ...
        if (is_page()) {
            ...
            $core_page_meta = [
                ...
                'travel' => 'Best time to visit Japan, Iceland, Ireland, Portugal, Costa Rica, Mexico, Puerto Rico, Alaska and Hawaii — month-by-month weather, crowds and cost, plus when to book cheap flights.',
                'auto' => 'How long a car battery lasts, how long an oil change takes, when to replace brake pads, and how often to rotate tires — the service-interval reference for everyday car ownership.',
                'beauty' => 'How long a spray tan and sun tan last, how long a belly-button piercing takes to heal, and how often to wash your hair — beauty and self-care duration and frequency guides.',
                'body' => 'How many times a day should you pee and poop? The normal ranges, what changes frequency, and when a change means it is time to call a doctor. Health information, not medical advice.',
                'health' => 'How long does a sprained ankle take to heal (by grade) and how long do broken ribs take to recover? Grade-by-grade injury recovery timelines and red-flag symptoms.',
                'craft' => 'How long does fermentation take? Times for beer, bread, yogurt, kombucha, sauerkraut, kimchi and wine — by product, with the variables that change them.',
                'gardening' => 'How long do grass seeds take to germinate and grow? Germination by grass type, time to first mow, and the soil-temperature and moisture variables that decide it.',
                'household' => 'How often should you wash your sheets? Every 1–2 weeks — adjusted for pets, allergies, sweat and illness. What builds up between washes and why it matters.',
                ...
                'gaming' => 'How long is a Fortnite match, a Valorant game, or a full Minecraft day? Real-world session lengths by game and mode, with official-rule verification — so you play on a clock, not past bedtime.',
                'food-storage' => 'How long do hard-boiled eggs, raw eggs, cooked chicken, rice, cheesecake and flour last? USDA-cited fridge and pantry storage times, spoilage signs and the 2-hour rule.',
